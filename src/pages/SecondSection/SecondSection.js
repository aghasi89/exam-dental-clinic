    ...
    return (
      < div className="second-section">
        <div className="info-bar">
          ...
          <InfoBar paragraph="Quisque eget nisl id nulla sagittis auctor quis id. Aliquam quis vehicula enim,
                       non aliquam risus. Sed a tellus quis mi rhoncus dignissim" />
          <InfoBar paragraph="Integer rutrum ligula eu dignissim laoreet. Pellentesque venenatis nibh sed
