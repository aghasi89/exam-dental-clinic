        ...
        <div className="cv-info-tab-container">
          <div className="full-content">
            <div className="degree-icon">
              ...
              <span className="deg-line">Կրթություն</span>
            </div>
            <div className="all-arrs-icon">
              ...
              <div className="education-sec">
                <img src={Arr} className="study-arrow" alt="DocProfileImage" />
                <span>
                  2004-2005թթ Ինտերնատուրիա՝ կլինիկական օրդինատոր, (ընտանեկան
                  ստոմատոլոգիայի ամփոփում):
                </span>
              </div>
            </div>
          </div>
          <div className="full-content-sec">
            <div className="degree-icon">
              <img src={DocSkills} className="deg" alt="degree" />
              <span className="deg-line">Աշխատանք</span>
            </div>
            <div className="all-arrs-icon">
              <div className="education">
                <img src={Arr} className="study-arrow" alt="DocProfileImage" />
              ...
              <div className="education-sec">
                <img src={Arr} className="study-arrow" alt="DocProfileImage" />
                <span>
                  2008-2018թթ Իսրայել, քաղաք՝ Երուսաղեմի առաջատար կլինիկա՝
                  իմպլանտոլոգ:
                </span>
              </div>
              <div className="education">
                <img src={Arr} className="study-arrow" alt="DocProfileImage" />
                <span>
                  2018-2020թթ Ախուրյանի «Մոր և մանկան» ծննդատուն՝ հղիների
                  ստոմատոլոգ:{" "}
                </span>
              </div>
              <div className="education-sec">
